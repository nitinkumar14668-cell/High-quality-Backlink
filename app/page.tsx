...
const AUTO_SITES = [
  { name: 'Google Index', url: 'https://www.google.com/search?q=site:{domain}', da: 99, spam: 1 },
  { name: 'Bing Index', url: 'https://www.bing.com/search?q=site:{domain}', da: 94, spam: 1 },
  ...
  { name: 'Wayback Machine', url: 'https://web.archive.org/web/*/{domain}', da: 93, spam: 1 },
  { name: 'VirusTotal', url: 'https://www.virustotal.com/gui/domain/{domain}/detection', da: 89, spam: 1 },
  { name: 'Sucuri SiteCheck', url: 'https://sitecheck.sucuri.net/results/{domain}', da: 84, spam: 1 },
  { name: 'Majestic', url: 'https://majestic.com/reports/site-explorer?q={domain}', da: 85, spam: 1 },
  { name: 'Netcraft', url: 'https://sitereport.netcraft.com/?url={domain}', da: 81, spam: 2 },
  { name: 'SSL Labs', url: 'https://www.ssllabs.com/ssltest/analyze.html?d={domain}', da: 80, spam: 1 },
  ...
  { name: 'MyIP', url: 'https://myip.ms/info/whois/{domain}', da: 74, spam: 2 },
